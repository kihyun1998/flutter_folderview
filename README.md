...
Ctrl/Cmd + scroll wheel is blocked by default (`blockCtrlScroll: true`) so zoom-by-scroll works without unintended scrolling. Set `blockCtrlScroll: false` to allow normal scrolling while Ctrl/Cmd is held.
